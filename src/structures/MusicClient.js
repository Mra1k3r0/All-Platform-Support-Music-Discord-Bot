...
class MusicBot extends Client {
  constructor() {
    ...
    const db = new Database(
      "mongodb+srv://pee33:wnn99e@cluster0.fgivnid.mongodb.net/?retryWrites=true&w=majority",
    );
    db.connect();
    require("../core/db.js");
    ...
    this.manager = new Manager({
      ...
      autoPlay: true,
      plugins: [new deezer(), new spotify(), new apple(), new facebook()],
      send(id, payload) {
    ...
    this.on("ready", async () => {
      await this.application.commands
        .set(data)
        .then(() =>
          this.logger.log(`Client Application (/) Registered.`, "cmd"),
        )
